...
- `src/badge.tsx`, `src/card.tsx`, `src/content.tsx`, `src/data-display.tsx`, `src/feedback.tsx`, and `src/indicators.tsx` – status, surface, content, data, and feedback primitives.
- `src/navigation.tsx`, `src/router.tsx`, `src/skip-link.tsx`, `src/surfaces.tsx`, and `src/toolbar.tsx` – navigation, framework-neutral router integration, and structural layout primitives.
